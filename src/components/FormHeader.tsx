            ...
            <div className="box px-0 py-0 is-clipped">
                <div className="titleboxbg">
                    <div className="titlebox">
                        <p className=" title is-capitalized is-size-3 has-text-weight-bold mb-3" title={props.title}>
                            {props.title}
                        </p>
                        <div className="descbox is-size-6 has-text-weight-medium  ">
                            <div dangerouslySetInnerHTML={{ __html: props.description }} title="Description"/>
                        </div>
